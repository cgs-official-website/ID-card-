...
import { ArrowLeft, Download, UserCircle2, MapPin, Droplets, Mail, Phone, Building, Edit2, Check, X, Calendar, Briefcase, HeartPulse, ExternalLink } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
                  ...
                  <div className="flex items-start gap-4 group min-w-0">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-slate-800 font-bold text-base">{employee.phoneNumber}</p>
                    </div>
                  </div>
