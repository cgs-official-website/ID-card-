...
const Radio = ({ label, name, value, checked, onChange, icon: Icon }) => {
  return (
    <label className={`flex items-center justify-center gap-3 p-4 rounded-2xl border-2 cursor-pointer transition-all w-full select-none ${
      checked 
        ? 'border-yellow-500 bg-yellow-500/10 text-yellow-300 font-bold shadow-[0_0_15px_rgba(139,92,246,0.15)]' 
        : 'border-[#222222]/50 text-gray-400 hover:bg-[#1A1A1A]/30 hover:text-white'
    }`}>
      <input
        type="radio"
        name={name}
